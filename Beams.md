...
to the increased moment the taper gives against plate deflection. Their tapers are .75HU in height
to ensure that 1HU of clearance in an assembly is enough to accomodate e.g: a cover on top of a plate
which is 1HU below the plate atop the beam. Just before the nubbed connectors, the taper also has
a .25HU pad to provide visual seamlessness with any nubbed covers mounted to the bottom side
of the top plate. 
