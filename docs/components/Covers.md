...
Clipped and nubbed covers are Plaice components which go one step further from [plugs](/docs/components/Plugs.md), and add a thin [`.25 HU`](/docs/design/Units.md) slab of material over the top of a bunch of plugs.
